...
export function DashboardHighlightsSection({ topItems = [] }: DashboardHighlightsSectionProps) {
  ...
  return (
    <section className="space-y-5">
      <DashboardSectionHeader
        ...
        description="From sale invoices and returns — customer rankings live in the receivables panel above."
      />
      <Card className="rounded-2xl border border-border/80 bg-gradient-to-br from-card via-card to-muted/15 shadow-sm ring-1 ring-black/[0.03] dark:ring-white/[0.04]">
        <CardHeader className="pb-3 sm:pb-4">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <CardTitle className="text-base font-semibold">By revenue</CardTitle>
              ...
              <div className="flex flex-col items-center gap-3 rounded-xl px-2 py-8 text-center">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground/90">
                    Add items and record sale invoices to see rankings here.
                  </p>
                </div>
