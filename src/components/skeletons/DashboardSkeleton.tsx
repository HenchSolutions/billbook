...
/** Mirrors `DashboardPageClient` layout: header band, 5 KPIs, chart, two cards, inventory, ledger. */
        ...
        <section className="border-b border-border/40 pb-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
            <div className="space-y-2">
              <Skeleton className="h-9 w-44 max-w-full sm:h-10" />
              <Skeleton className="h-5 w-full max-w-xl" />
              <Skeleton className="h-4 w-36" />
            </div>
            <Skeleton className="h-9 w-full rounded-lg sm:h-9 sm:w-52" />
          </div>
        </section>
